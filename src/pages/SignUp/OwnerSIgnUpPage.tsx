...
//사업자번호
const businessNumberRegex = /^\d{10}$/; //10자리
const [businessNumber, setBusinessNumber] = useState("");
const [isBusinessNumberValid, setIsBusinessNumberValid] = useState(true);
...
return (
    <div className="min-h-screen w-full bg-shades-01 px-[24px] pt-[48px] flex flex-col">
      ...
      <div className="flex flex-row">
        ...
        {/*아이디*/}
        <div className="mt-[17px] relative w-full">
        <span
            className="
            absolute
            top-[10px]
    ...
    `       }
        ...
        <input
            ...
            onChange={(e) => {
                ...
                setIsBusinessNumberValid(businessNumberRegex.test(value) || value === "");
        }}
         className="
             w-full
             h-[56px]
        ...
        <button
            type="button"
            disabled={!businessNumberRegex.test(businessNumber)}
            className={`
            absolute
            right-[12px]
            top-1/2
            ...
            border
            ${
                businessNumberRegex.test(businessNumber)
                ? "border-primary-01 text-primary-01 cursor-pointer"
                : "border-neutrals-05 text-neutrals-05 cursor-not-allowed"
            }
            `}
